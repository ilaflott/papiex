...
{
  APIDBG( "Entry: passed version: %#x, compiled version: %#x\n", version, PAPI_VER_CURRENT);
	...
	if ( version != PAPI_VER_CURRENT ) {
	  PAPIERROR( "Header/library version mismatch, passed %#x vs current %#x",version,PAPI_VER_CURRENT);
	  papi_return( PAPI_EINVAL );
	}
